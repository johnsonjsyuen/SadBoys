            ...
            <div style="padding-top:30px" class="panel-body" >
              ...
              <div style="margin-top:10px" class="form-group">
                ...
                <div class="col-sm-12 controls">
                  <a id="btn-login" href="#" class="btn btn-lg btn-success" style="display: block;margin:0 auto; background-color: #f22613;border:none;border-bottom: 4px solid #B92730;">Login  </a>
              </div>
          </div>
        ...
        <div class="panel-body" >
            <form id="signupform" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <!-- Button -->                                        
                    <div class="col-md-12">
                        <button id="btn-signup" type="button" class="btn btn-lg btn-success" style="display: block;margin:0 auto; background-color: #f22613;border:none;border-bottom: 4px solid #B92730;">Sign Up</button>
                    </div>
                </div>
            </form>
        </div>
